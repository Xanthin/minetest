...
#define MGWATERSHED_VERTICAL_SCALE 128.0
#define MGWATERSHED_RIDGE_HEIGHT 0.8
#define MGWATERSHED_VALLEY_BASE_AMP 1.6
#define MGWATERSHED_MOUNTAIN_AMP 2.0
#define MGWATERSHED_TUNNEL_WIDTH 0.03
...
struct MapgenWatershedParams : public MapgenSpecificParams {
	...
	NoiseParams np_valley1;
	NoiseParams np_valley2;
